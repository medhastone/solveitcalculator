            ...
            <div className="bg-surface-container-lowest p-space-lg rounded-xl shadow-md space-y-space-md">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-headline-md text-headline-md text-on-surface">Countdown to {endDate}</h3>
                </div>
                <span className="px-2 py-0.5 rounded bg-secondary-fixed text-on-secondary-fixed font-label-caps text-label-caps font-semibold uppercase">Active Orbit</span>
              </div>
...
with open('app/time-date/date-difference/DateDifferenceClient.tsx', 'w') as f:
    f.write(content)
