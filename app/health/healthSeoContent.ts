...
export const CLINICAL_SEO_GUIDES: Record<string, ClinicalGuide> = {
  ...
  'tdee': {
    ...
    metaTitle: 'TDEE Calculator — Accurate Total Daily Energy Expenditure & Calorie Deficit | SolveIt',
  ...
  'bmr': {
    ...
    metaTitle: 'BMR Calculator — Mifflin-St Jeor & Harris-Benedict Formulas | SolveIt',
  ...
  'navy-fat': {
    ...
    metaTitle: 'U.S. Navy Body Fat Calculator — Accurate Circumference Method | SolveIt',
  ...
  'water-matrix': {
    ...
    metaTitle: 'Daily Water Intake Calculator — Weight & Sweat Rate Matrix | SolveIt',
  ...
  'zone2': {
    ...
    metaTitle: 'Zone 2 Heart Rate Calculator — Karvonen HRR & Fat Oxidation Zone | SolveIt',
  ...
  'sleep-wake': {
    ...
    metaTitle: 'Sleep Cycle Calculator — 90-Minute Cycles & Optimal Wake Times | SolveIt',
  ...
  'due-date': {
    ...
    metaTitle: 'Pregnancy Due Date Calculator — LMP & Cycle Length Formula | SolveIt',
  ...
  '1rm': {
    ...
    metaTitle: 'One-Rep Max Calculator (1RM) — Epley & Brzycki Formulas | SolveIt',
  ...
  'macro-split': {
    ...
    metaTitle: 'Macro Calculator — High Protein, Fat & Carb Split Calculator | SolveIt',
  ...
  'protein-rda': {
    ...
    metaTitle: 'Protein Intake Calculator — Daily Grams for Muscle & Sarcopenia | SolveIt',
  ...
  'ibw': {
    ...
    metaTitle: 'Ideal Body Weight Calculator (IBW) — Devine & Robinson Formulas | SolveIt',
  ...
  'ffmi': {
    ...
    metaTitle: 'FFMI Calculator — Fat-Free Mass Index & Natural Muscular Limit | SolveIt',
  ...
  'whtr': {
    ...
    metaTitle: 'Waist-to-Height Ratio Calculator (WHtR) — Visceral Fat & Heart Health | SolveIt',
  ...
  'vo2max': {
    ...
    metaTitle: 'VO2 Max Calculator — Non-Exercise Heart Rate Ratio & Uth Formula | SolveIt',
...
export function getClinicalSeoGuide(toolId: string, toolConfig: {
  ...
  return {
    ...
    metaTitle: `${toolConfig.name} — Clinical Precision Tool | SolveIt`,
