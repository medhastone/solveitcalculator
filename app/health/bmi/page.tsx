...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://solveitcalculator.com/health/bmi',
  },
  openGraph: {
    ...
    url: 'https://solveitcalculator.com/health/bmi',
    type: 'website',
  },
  twitter: {
  ...
  '@graph': [
    {
      ...
      'itemListElement': [
        ...
        { '@type': 'ListItem', 'position': 3, 'name': 'BMI Calculator', 'item': 'https://solveitcalculator.com/health/bmi' }
      ]
    },
    {
      '@type': 'MedicalWebPage',
