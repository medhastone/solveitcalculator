...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: seoGuide.metaDescription,
      type: 'website',
      url: `https://solveitcalculator.com/health-fitness-calculators/${config.slug}`,
      siteName: 'SolveIt Calculator Suite',
    },
    alternates: {
      canonical: `https://solveitcalculator.com/health-fitness-calculators/${config.slug}`,
    },
  };
}
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: config.name, item: `https://solveitcalculator.com/health-fitness-calculators/${config.slug}` },
        ],
      },
      {
        '@type': 'MedicalWebPage',
