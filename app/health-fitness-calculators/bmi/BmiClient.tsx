          ...
          <div className="max-w-max-width-canvas mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-between gap-space-sm mb-space-md">
              <nav aria-label="Breadcrumb" className="flex items-center gap-space-xs font-body-sm text-body-sm text-on-surface-variant">
                ...
                <Link className="hover:text-primary transition-colors" href="/health-fitness-calculators">
                  Health &amp; Fitness
                </Link>
                <span className="text-outline-variant">/</span>
            ...
            <div className="mt-space-lg overflow-x-auto pb-space-2xs scrollbar-none">
              <div className="flex items-center gap-space-xs min-w-max">
                <Link className="px-space-md py-space-xs rounded-full bg-primary text-on-primary font-label-caps text-label-caps shadow-sm flex items-center gap-1.5 transition-transform hover:scale-[1.02]" href="/health-fitness-calculators/bmi">
                  <span className="material-symbols-outlined text-[16px]">grade</span>
                  BMI Calculator (Active)
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#tdee-card">
                  Calorie Deficit / TDEE
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#bmr-card">
                  BMR Mifflin-St Jeor
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#navy-card">
                  Navy Body Fat %
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#water-card">
                  Daily Water Hydration
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#zone2-card">
                  Zone 2 Heart Rate
                </Link>
                <Link className="px-space-md py-space-xs rounded-full bg-surface-container-lowest text-on-surface-variant hover:text-on-surface font-label-caps text-label-caps shadow-sm hover:bg-surface-container transition-all" href="/health-fitness-calculators#tdee-card">
        ...
        <section className="w-full py-space-xl bg-surface-container-low px-gutter-mobile lg:px-gutter-desktop border-t border-outline-variant/20">
          <div className="max-w-max-width-canvas mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-space-xs mb-space-lg">
              ...
              <Link className="font-label-caps text-label-caps text-primary hover:underline flex items-center gap-1 font-semibold" href="/health-fitness-calculators">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-space-md">
              {/* Tool 1 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#tdee-card">
                <div>
              ...
              {/* Tool 2 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#bmr-card">
                <div>
              ...
              {/* Tool 3 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#navy-card">
                <div>
              ...
              {/* Tool 4 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#water-card">
                <div>
              ...
              {/* Tool 5 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#zone2-card">
                <div>
              ...
              {/* Tool 6 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators#bmi-card">
                <div>
              ...
              {/* Tool 7 */}
              <Link className="p-space-md rounded-2xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all group flex flex-col justify-between border border-outline-variant/20" href="/health-fitness-calculators">
                <div>
